  ...
  factory Disease.fromJson(Map<String, dynamic> json) {
    return Disease(
      ...
      medicationDescription: json['medicationDescription'] != null
          ? MedicationDescription.fromJson(json['medicationDescription'])
          : null,
      symptomDescription: json['symptomDescription'] != null
          ? LanguageData.fromJson(json['symptomDescription'])
          : null,
      whois: json['whois'] != null ? Whois.fromJson(json['whois']) : null,
      testsProceduresList: json['testsProceduresList'] != null
          ? (json['testsProceduresList'] as List<dynamic>)
              .map((item) => LanguageData.fromJson(item))
              .toList()
          : null,
      medicationsList: json['medicationsList'] != null
          ? (json['medicationsList'] as List<dynamic>)
              .map((item) => LanguageData.fromJson(item))
              .toList()
          : null,
      diseaseSymptoms: json['diseaseSymptoms'] != null
          ? (json['diseaseSymptoms'] as List<dynamic>)
              .map((item) => DiseaseSymptom.fromJson(item))
              .toList()
          : null,
  ...
  factory DiseaseSymptom.fromJson(Map<String, dynamic> json) {
    return DiseaseSymptom(
      ...
      symptom: json['symptom'] != null
          ? LanguageData.fromJson(json['symptom'])
          : null,
